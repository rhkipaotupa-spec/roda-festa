...
/* V19.10G_PDF_SUMMARY_ONLY */
.summary-page .brandline{margin-bottom:7mm}
.summary-page>h2{margin:0 0 4mm;color:#4c2c22;font-size:20pt}
.summary-page .facts{grid-template-columns:repeat(2,minmax(0,1fr));gap:0 8mm;margin:0 0 9mm;border-top:1px solid #d8bd96}
.summary-page .fact{min-height:16mm;padding:4mm 0;border:0;border-bottom:1px solid #dec9a7;border-radius:0;background:transparent;box-shadow:none}
.summary-page .fact span{color:#9a7046;font-size:7.6pt;letter-spacing:.1em}
.summary-page .fact strong{margin-top:1.6mm;color:#432b20;font-size:10.5pt;font-weight:600;line-height:1.25}
.summary-page .menu-group{margin:3.5mm 0;border:1px solid #dec9a7;border-radius:3mm;background:#fffaf1;box-shadow:none;overflow:hidden}
.summary-page .menu-group h3{margin:0;padding:2.8mm 4mm;color:#4c2c22;background:#f4e7d4;border-bottom:1px solid #e3cba7;font-size:12.5pt;font-weight:500}
.summary-page .menu-line{gap:6mm;padding:2.2mm 4mm}
.summary-page .menu-line span{font-size:9.2pt;font-weight:600}
.summary-page .menu-line strong{padding:0;border:0;border-radius:0;background:transparent;color:#6d503d;font-size:8.5pt}
@media print{.summary-page .fact,.summary-page .menu-group{page-break-inside:avoid;break-inside:avoid}}
</style>
</head>
<body>
