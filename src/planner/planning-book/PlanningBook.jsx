...
const EVENT_OPTIONS = [
  ...
  { id: "cha-bebe", label: "Chá de bebê", description: "Uma celebração acolhedora para receber o bebê com carinho." },
...
function buildProposalHtml(snapshot) {
  const presentation = buildProposalPresentation({
    ...
    consignmentTotal: snapshot.consignmentTotal,
    realGuests: snapshot.realGuests,
  });
...
/* V19.10F_PDF_CLEAN_CONTINUITY */
.cover{justify-content:center;align-items:flex-start;text-align:left;padding:24mm 22mm 20mm;background:#fbf5e9;color:#432b20;border-top:7mm solid #4c2c22}
.cover::after{content:"";position:absolute;left:22mm;right:22mm;bottom:18mm;height:1px;background:#caa976}
.cover img{width:42mm;margin:0 0 14mm;padding:5mm 6mm;border-radius:5mm;background:#4c2c22;box-shadow:none}
.cover-tagline{margin:0 0 16mm;color:#9a7046;font-size:8.4pt;font-weight:700;letter-spacing:.12em}
.cover .eyebrow{color:#9b6d32}
.cover h1{max-width:145mm;margin:5mm 0 2mm;color:#4c2c22;font-size:34pt;line-height:1.02}
.cover h2{margin:0 0 14mm;color:#6f5848;font-family:Georgia,serif;font-size:20pt;font-weight:400}
.chips{justify-content:flex-start;gap:3mm}
.chips span{border:1px solid #d8bd96;background:#fffaf1;color:#6d503d;padding:2.6mm 4mm}
.fact{border-color:#e0cdae;border-radius:3mm;padding:3.5mm 4mm;box-shadow:none;background:#fffdf8}
.menu-group{margin:4mm 0;border-color:#e0cdae;border-radius:3mm;background:#fffdf8;box-shadow:none;border-left:1.2mm solid #4c2c22}
.menu-group h3{padding:3mm 4mm;color:#4c2c22;background:#f4e7d4;border-bottom:1px solid #e3cba7;font-size:13pt}
.menu-line{padding:2.4mm 4mm}
.menu-line strong{padding:0 0 0 2.5mm;border:0;border-left:1px solid #d6b98c;border-radius:0;background:transparent;color:#6d503d}
@media print{.page.cover{min-height:297mm;position:relative;padding:24mm 22mm 20mm;background:#fbf5e9!important;color:#432b20!important;border-top:7mm solid #4c2c22;page-break-after:always;break-after:page}.page.cover .eyebrow{color:#9b6d32!important}}</style>
</head>
<body>
...
export default function PlanningBook() {
  ...
  const proposalPresentation = buildProposalPresentation({
        ...
        <div className="rf-flow-shell">
          ...
          {stepIndex === 4 && suggestion && (
            <section className="rf-screen">
              ...
              <div className="rf-review-money-grid">
                <div><span>Investimento contratado</span><strong>{formatCurrency(proposalPresentation.investmentTotal)}</strong><small>{formatCurrency(proposalPresentation.contractedPerPerson)} por pessoa.</small></div>
