...
export const PRODUCTS = {
  ...
  tortaCebolaCaramelizada: { id: "torta-cebola-caramelizada-queijo", name: "Cebola caramelizada com queijo", commercialCategory: "Tortas", operationalGroup: "hotSandwiches", productionPerHour: 40, suggestedUnitsPerEquivalentGuest: 1, lotSize: 1, unitPrice: 7, priceUnit: "portion150g", portionGrams: 150, active: true },
  tortaStrogonoffFrango: { id: "torta-strogonoff-frango", name: "Strogonoff de frango", commercialCategory: "Tortas", operationalGroup: "hotSandwiches", productionPerHour: 40, suggestedUnitsPerEquivalentGuest: 1, lotSize: 1, unitPrice: 7, priceUnit: "portion150g", portionGrams: 150, active: true },
  tortaFrangoCatupiry: { id: "torta-frango-catupiry", name: "Frango com catupiry", commercialCategory: "Tortas", operationalGroup: "hotSandwiches", productionPerHour: 40, suggestedUnitsPerEquivalentGuest: 1, lotSize: 1, unitPrice: 7, priceUnit: "portion150g", portionGrams: 150, active: true },
  tortaFrangoCreamCheese: { id: "torta-frango-cream-cheese-ervas", name: "Frango com cream cheese e ervas", commercialCategory: "Tortas", operationalGroup: "hotSandwiches", productionPerHour: 40, suggestedUnitsPerEquivalentGuest: 1, lotSize: 1, unitPrice: 7, priceUnit: "portion150g", portionGrams: 150, active: true },
  tortaPalmitoCatupiry: { id: "torta-palmito-catupiry", name: "Palmito com catupiry", commercialCategory: "Tortas", operationalGroup: "hotSandwiches", productionPerHour: 40, suggestedUnitsPerEquivalentGuest: 1, lotSize: 1, unitPrice: 9, priceUnit: "portion150g", portionGrams: 150, active: true },
  tortaCamaraoCatupiry: { id: "torta-camarao-catupiry", name: "Camarão com catupiry", commercialCategory: "Tortas", operationalGroup: "hotSandwiches", productionPerHour: 40, suggestedUnitsPerEquivalentGuest: 1, lotSize: 1, unitPrice: 15, priceUnit: "portion150g", portionGrams: 150, active: true },
  tortaCarneLoucaCheddar: { id: "torta-carne-louca-cheddar", name: "Carne louca com cheddar", commercialCategory: "Tortas", operationalGroup: "hotSandwiches", productionPerHour: 40, suggestedUnitsPerEquivalentGuest: 1, lotSize: 1, unitPrice: 15, priceUnit: "portion150g", portionGrams: 150, active: true },
  tortaBacalhauCatupiry: { id: "torta-bacalhau-catupiry", name: "Bacalhau com catupiry", commercialCategory: "Tortas", operationalGroup: "hotSandwiches", productionPerHour: 40, suggestedUnitsPerEquivalentGuest: 1, lotSize: 1, unitPrice: 15, priceUnit: "portion150g", portionGrams: 150, active: true },
